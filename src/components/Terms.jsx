        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <div className="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-700 lg:max-w-none lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-8">
              Please note that we may change these terms and conditions at any time without notice. Any changes will be posted on this page. If you have any questions, please contact us at Logan@kriegertx.com
              </p>
            </div>
          </div>
